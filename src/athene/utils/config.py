...
class Config:
    ...
    #BASE_DIR ="/home/robi/PycharmProjects/fever_challenge/fever-2018-team-fever-gplsi/"
    BASE_DIR = os.getcwd()
    ...
    relative_path_db = "data/fever/fever.db"

    @classmethod
    def db_path(self):
        return path.join(self.BASE_DIR, self.relative_path_db)
    ...
    relative_path_test_file = "data/fever-data/test.jsonl"

    @classmethod
    def raw_test_set(self):
        return path.join(self.BASE_DIR, self.relative_path_test_file)
    ...
    relative_path_submission="data/submission/predictions.jsonl"
    relative_submission_folder="data/submission"
    submission_folder = path.join(BASE_DIR, relative_submission_folder)

    @classmethod
    def submission_file(cls):
        return path.join(cls.BASE_DIR, cls.relative_path_submission)
