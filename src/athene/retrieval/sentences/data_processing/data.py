...
class Data(object):
    ...
    # def __init__(self,embedding_path, test_file, db_filepath="data/fever/fever.db"):
    #     self.embedding_path = embedding_path
    #     self.test_file = test_file
    #     self.db_filepath = db_filepath
    #     self.db = FeverDocDB(self.db_filepath)
    ...
    def data_pipeline(self):
        ...
        #Claim con cada posible orasión
    ...
    def extract_Data_DB(self, datapath):
        ...
        with open(datapath, "rb") as f:
            ...
            for line in tqdm(lines):
                ...
                # print(len(dev))
                if len(dev) == 1:
                    dev.append('no evidence for this claim')
                    indexes.append(('empty', 0))
                devs.append(dev)
                all_indexes.append(indexes)
        return devs, all_indexes
    ...
    def predict_data_loader(self, predict_data_path, data_path):
        ...
        if os.path.exists(predict_data_path):
            ...
            with open(predict_data_path, "rb") as f:
                data = pickle.load(f)
                #location_indexes is a pages and index sentences
    ...
    #Extract word in sentences and find index in word_dict
    ...
    def train_data_indexes(self, X, word_dict):
        ...
        return X_indexes
    #Tranforma las palabras en indices dentro de un diccionario
